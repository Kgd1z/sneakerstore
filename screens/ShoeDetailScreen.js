    ...
    <SafeAreaView style={styles.container}>
      <View style={{ marginLeft: 0 }}>
        <View style={{ marginLeft: 20 }}>
          ...
          <View>
            <Image
              style={{ width: 360, height: 180, marginTop: 40 }}
              source={item.img}
            />
          </View>
          ...
          <View style={{ flexDirection: "row" }}>
            <Text style={{ fontSize: 23, color: "grey", paddingRight: 240 }}>
              Select Size
            </Text>
        ...
        <SlidingUpPanel>
          <View style={styles.slider}>
            ...
            ></View>
            <View
              style={{ flexDirection: "row", paddingTop: 30, paddingLeft: 20 }}
            >
              <Text
                style={{ paddingRight: 210, fontSize: 25, fontWeight: "bold" }}
              >
                {item.name}
              </Text>
